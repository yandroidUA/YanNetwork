...
data class ElementLine(
   ...
   private val rect: Rect by lazy {
      ...
      Rect(
         topLeft = Offset(leftX - LINE_THRESHOLD / 2f, topY - LINE_THRESHOLD / 2f),
         bottomRight = Offset(rightX + LINE_THRESHOLD / 2f, bottomY + LINE_THRESHOLD / 2f)
      )
   }
